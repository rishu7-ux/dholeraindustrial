    ...
    <section className="relative overflow-hidden bg-[#f7fbff] py-20 sm:py-24 lg:py-28">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          {projects.map((project) => (
            <motion.article
              ...
              className="group relative overflow-hidden rounded-[30px] border border-white/60 bg-white/60 shadow-[0_20px_60px_rgba(18,86,141,0.10)] backdrop-blur-xl"
            >
              <div className="grid lg:grid-cols-[44%_56%]">
                {/* ================= LEFT IMAGE ================= */}

                <div className="relative min-h-[300px] overflow-hidden sm:min-h-[380px] lg:min-h-[400px]">
                  <motion.div
                    whileHover={{
                      scale: 1.06,
                    }}
                  ...
                  <motion.div
                    ...
                    className="absolute left-6 top-6 flex h-12 w-12 items-center justify-center rounded-xl border border-white/30 bg-white/15 text-sm font-black text-white shadow-xl backdrop-blur-md"
                  >
                    {project.id}
                  </motion.div>
                  ...
                  <div className="absolute bottom-5 left-5 right-5">
                    <motion.div
                      ...
                      className="w-fit rounded-xl border border-white/25 bg-black/35 px-5 py-3 text-white backdrop-blur-xl"
                    >
                ...
                <div className="relative flex flex-col justify-center p-7 sm:p-9 lg:p-11">
                  ...
                  <p className="relative z-10 text-[10px] font-black uppercase tracking-[0.25em] text-[#fdb713]">
                    Featured Project
                  </p>

                  <h3 className="relative z-10 mt-3 font-serif text-3xl font-black text-[#12568d] sm:text-4xl">
                    {project.title}
                  </h3>
                  ...
                  <motion.div
                    ...
                    className="relative z-10 mt-5 flex origin-left gap-2"
                  >
        ...
        >
          <Link
            href="/properties"
            className="group inline-flex items-center gap-3 rounded-xl border border-[#12568d]/15 bg-white/70 px-8 py-4 text-sm font-black uppercase tracking-wide text-[#12568d] shadow-lg backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:bg-[#12568d] hover:text-white"
          >
            View All Properties
