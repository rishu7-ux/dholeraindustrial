      ...
      <main className="compact-page property-detail-page overflow-hidden bg-white text-[#0A2E73]">
              ...
              <div className="property-contact-grid mt-5 grid grid-cols-2 gap-2 sm:mt-8 sm:block sm:space-y-5">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 font-black text-[#0A2E73]">
              ...
              <div className="mt-7 space-y-5">
                {locationPoints.map((item) => (
                  ...
                  >
                    ...
                    <div>
                      <p className="font-black text-[#081A3A]">{item.title}</p>
                      <p className="mt-1 leading-7 text-[#0A2E73]">{item.description}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              {projectVisionPoints.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="mt-7 text-xl font-black text-[#081A3A]">{item.title}</h3>
                    <p className="mt-3 leading-7 text-[#0A2E73]">{item.description}</p>
                  </motion.div>
                );
              })}
              ...
              >
                ...
                <p className="mt-3 leading-7 text-[#0A2E73]">
        ...
        <section className="bg-white py-20 lg:py-28">
          <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
            ...
            >
              <FaIndustry size={27} className="text-[#FF7A00]" />
        ...
        <section className="bg-[#081A3A] py-20 text-white lg:py-28">
          <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
            ...
            >
              <p className="font-black text-[#FF7A00]">Why it&apos;s a smart investment:</p>
              <div className="mt-7 space-y-5">
        ...
        <section className="bg-white py-20 lg:py-28">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-12 lg:grid-cols-2">
              ...
              >
                <p className="text-xl font-black text-[#081A3A]">Project Highlights:</p>
                <div className="mt-7 space-y-4">
                  {projectHighlights.map((item) => (
                    <div key={item} className="flex items-center gap-4 rounded-xl bg-white p-4 shadow-sm">
                      ...
                      <span className="font-semibold text-[#0A2E73]">{item}</span>
                    </div>
                  ))}
                </div>
              </motion.div>
