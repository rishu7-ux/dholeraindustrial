      ...
      <main>
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
            <motion.div variants={fadeLeft} initial="hidden" animate="visible">
              ...
              <div className="mt-8 space-y-5">
                ...
                <Link href="tel:+919667798802" className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-[0.25em] text-slate-400">Call Our Expert</p>
                    <p className="mt-1 text-lg font-black text-[#12568d]">+91 9667798802</p>
                  </div>
                </Link>
              </div>
              ...
              <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                <Link href="#enquiry" className="group inline-flex min-h-13 items-center justify-center gap-3 rounded-xl bg-[#fdb713] px-7 py-4 text-sm font-black uppercase tracking-wide text-[#12568d] transition hover:-translate-y-1">
                  Schedule Visit
                  <FaArrowRight size={12} className="transition-transform group-hover:translate-x-2" />
                </Link>
                <Link href="tel:+919667798802" className="inline-flex min-h-13 items-center justify-center gap-3 rounded-xl border border-[#12568d]/20 bg-white px-7 py-4 text-sm font-black uppercase tracking-wide text-[#12568d]">
            ...
            <motion.div variants={fadeRight} initial="hidden" animate="visible" className="relative">
              ...
              <div className="relative overflow-hidden rounded-[30px] bg-white pt-28 shadow-[0_30px_80px_rgba(18,86,141,0.16)]">
                <div className="absolute right-7 top-7 z-10 rounded-2xl bg-slate-900/15 px-6 py-5 backdrop-blur-md">
                  <p className="text-[10px] font-black uppercase tracking-[0.25em] text-[#fdb713]">Dholera SIR</p>
                ...
                <div className="relative h-97.5 sm:h-117.5">
                  ...
                  <div className="absolute bottom-7 left-7 right-7 max-w-xl rounded-[22px] border border-white/25 bg-black/55 p-6 text-white backdrop-blur-md sm:p-7">
                    <p className="text-[10px] font-black uppercase tracking-[0.25em] text-[#fdb713]">Prime Logistics Zone</p>
                    ...
                    <p className="mt-4 flex items-center gap-2 text-sm font-bold">
                      <FaRoad className="text-[#fdb713]" /> 55 Metre Wide Road
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="bg-[#f4f9fd] py-20 lg:py-28">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <p className="text-xs font-black uppercase tracking-[0.3em] text-[#fdb713]">Project Overview</p>
              <h2 className="mt-5 font-serif text-4xl font-black text-[#12568d] sm:text-5xl">Key Project Details</h2>
              ...
              {projectOverview.map(([label, value]) => (
                <motion.div variants={cardReveal} key={label}
                  ...
                  <div className="flex items-center gap-4 font-black text-[#12568d]">
                    <span className="h-3 w-3 rounded-full bg-[#fdb713]" /> {label}
                  </div>
                  <div className="border-[#12568d]/10 font-semibold text-slate-600 sm:border-l sm:pl-10">{value}</div>
                </motion.div>
              ))}
            </motion.div>
          </div>
        ...
        <section className="bg-white py-20 lg:py-28">
          <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[1fr_0.95fr] lg:px-8">
            <motion.div variants={fadeLeft} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              <p className="text-xs font-black uppercase tracking-[0.3em] text-[#fdb713]">Strategic Location</p>
            ...
            <motion.div variants={fadeRight} initial="hidden" whileInView="visible" viewport={{ once: true }}
              ...
              <h3 className="text-xl font-black text-[#12568d]">Principal Benefits Of The Location</h3>
        ...
        <section className="bg-[#fffaf0] py-20 lg:py-28">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <p className="text-xs font-black uppercase tracking-[0.3em] text-[#fdb713]">Ideal Land Use</p>
              ...
              {idealUses.map((item) => {
                ...
                return (
                  <motion.div key={item.title} variants={cardReveal} whileHover={reduceMotion ? undefined : { y: -8 }}
                    ...
                    <h3 className="mt-7 text-xl font-black leading-8 text-[#12568d]">{item.title}</h3>
                  </motion.div>
                );
              })}
            </motion.div>
        ...
        <section className="bg-[#f7fbff] py-20 lg:py-28">
          <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
            <motion.div variants={fadeLeft} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              <p className="text-xs font-black uppercase tracking-[0.3em] text-[#fdb713]">Total Area &amp; Plot Sizes</p>
              <h2 className="mt-5 font-serif text-4xl font-black text-[#12568d] sm:text-5xl">Flexible Plot Configuration</h2>
            ...
            <motion.div variants={fadeRight} initial="hidden" whileInView="visible" viewport={{ once: true }} className="grid gap-5 sm:grid-cols-2">
              <div className="rounded-3xl bg-[#12568d] p-8 text-white">
                <p className="text-xs font-black uppercase tracking-[0.2em] text-[#fdb713]">Plot Size</p>
                <p className="mt-4 text-4xl font-black">1000 SQYD</p>
              </div>
              <div className="rounded-3xl bg-[#fdb713] p-8 text-[#12568d]">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-12 lg:grid-cols-2">
              ...
              <motion.div
                ...
                whileInView="visible"
                viewport={{ once: true }}
                className="relative overflow-hidden rounded-[28px] bg-[#12568d] p-7 text-white shadow-[0_22px_65px_rgba(18,86,141,0.22)] sm:p-9"
              >
